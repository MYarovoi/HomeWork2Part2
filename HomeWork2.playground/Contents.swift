...
for index in 0 ..< cityNames.count {
    ...
    // 134 строка може генерувати число більше, ніж 135. Робимо заміну, оскільки вважаю, що цією умовою можно знехтувати в рамках завдання.
    if weatherInfo.2 > weatherInfo.3 {
        let exchangeLet = weatherInfo.2
        weatherInfo.2 = weatherInfo.3
        weatherInfo.3 = exchangeLet
    }
...
for index in 0 ..< weatherInCities.count {
    ...
    print("\n\(city):")
    print("t: \(kelvinToCelsius(kelvin)) C")
    print("t: \(kelvinToFahrenheit(kelvin)) F")
    print("min t: \(kelvinToCelsius(kelvinMin)) C / \(kelvinToFahrenheit(kelvinMin)) F")
    print("max t: \(kelvinToCelsius(kelvinMax)) C / \(kelvinToFahrenheit(kelvinMax)) F")
}
print("\n-----------------------------")
print("\n\n")
...
for index in 0 ..< weatherInCities.count {
    ...
    let city = weatherInfo.0
    let kelvin = weatherInfo.1
    print("\n\(city):\nt: \(String(format: "%.1f", kelvinToCelsius(kelvin))) C")
}
print("\n-----------------------------")
print("\n\n")
